...
async function seedProduct() {
    try {
        ...
        const getRes = await axios.get(`http://localhost:5000/api/products?_id=${productId}`);
        ...
        const updateRes = await axios.put(`http://localhost:5000/api/products/${productId}`, form, {
            headers: {
                ...form.getHeaders()
            }
        });
